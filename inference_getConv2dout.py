...
model_prefix = "output_inference/picodet_s_416_lcnet_quant_only_tail_conv2d/model"   # 不带 .pdmodel / .pdiparams
save_npy = "conv2dOut.npy"
...
# 打印第一个channel的前10个元素
print("first 10 elements of the first channel:", output[0, 1, 0, :10])
