...
model_prefix = "output_inference/picodet_s_416_lcnet_quant_cut1/model"   # 不带 .pdmodel/.pdiparams
save_prefix = "output_inference/picodet_s_416_lcnet_quant_only_head/model"
...
target_var_name = "hardswish_1.tmp_0"
