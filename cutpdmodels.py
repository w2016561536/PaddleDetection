...
model_prefix = "output_inference/picodet_s_416_lcnet_quant/model"   # 不带 .pdmodel/.pdiparams
save_prefix = "output_inference/picodet_s_416_lcnet_quant_cut1/model"
...
target_var_name = "hardswish_3.tmp_0"
