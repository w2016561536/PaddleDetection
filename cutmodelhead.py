...
src_prefix = "output_inference/picodet_s_416_lcnet_quant_cut1/model"       # 你上一步保存的模型，不带后缀
dst_prefix = "output_inference/picodet_s_416_lcnet_quant_only_tail/model"        # 新输出，不带后缀
new_input_name = "hardswish_1.tmp_0"
