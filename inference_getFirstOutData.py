...
model_prefix = "output_inference/picodet_s_416_lcnet_quant_only_head/model"   # 不带 .pdmodel / .pdiparams
save_npy = "output_hardwish_1.npy"
...
input_data = np.load("raw_pic_blob.npy").astype("float32")
